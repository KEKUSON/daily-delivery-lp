...
export const PixelButton = <E extends ElementType = 'button'>({
  ...
  const baseStyles = "relative inline-block px-6 py-3 font-retro text-lg font-bold border-4 border-white cursor-pointer transition-transform duration-150 [transition-timing-function:steps(2,end)] hover:-translate-y-1 active:translate-y-0 text-center";
  const variants = {
